...
export const sources = {
    fortune: 'Fortune',
    seraphim: 'Seraphim Capital',
    americanInno: 'American Inno',
    builtIn: 'Built In',
    businessWire: 'Business Wire',
    geospatialWorld: 'Geospatial World',
    carrierManagement: 'Carrier Management',
    aiAuthority: 'AI Authority',
    digIn: 'Dig In',
    claimsJournal: 'Claims Journal',
    crowdfundInsider: 'Crowdfund Insider',
    propertyCasualty360: 'Property Casualty 360',
    prWeb: 'PRWeb'
}
...
const mediaMentions = [
    ...
    },
    {
        ...
        source: sources.propertyCasualty360,
